...
class ConfigurationManager:
    ...
    def load_configuration(self) -> Dict[str, Any]:
        ...
        # This maintains backward compatibility while allowing file configs to take precedence
        env_data = {}
        env_vars = {
    ...
    def _get_config_file_paths(self) -> list[Path]:
        ...
        paths = [
            ...
            Path(__file__).parents[2] / "etc" / "tb.rc"  # Project-specific (highest priority)
        ]
        return paths
