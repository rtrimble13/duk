...
class CacheManager:
    ...
    def get_treasury_data(self, start_date: Optional[str] = None, 
                         ...
                         days: Optional[int] = None) -> Optional[List[Dict[str, Any]]]:
    ...
    def store_treasury_data(self, data: List[Dict[str, Any]], 
    ...
    def get_price_data(self, ticker: str, data_type: str = "price",
                      start_date: Optional[str] = None, 
                      end_date: Optional[str] = None,
                      days: Optional[int] = None) -> Optional[List[Dict[str, Any]]]:
        ...
        try:
            with sqlite3.connect(self.db_path) as conn:
                ...
                if result:
                    ...
                    data = json.loads(result[0])
                    logger.debug(f"Cache hit for {ticker} {data_type} data: {cache_key}")
                    return data
    ...
    def store_price_data(self, ticker: str, data: List[Dict[str, Any]], 
                        data_type: str = "price",
                        start_date: Optional[str] = None,
                        end_date: Optional[str] = None,
                        days: Optional[int] = None):
        ...
        try:
            with sqlite3.connect(self.db_path) as conn:
                ...
                cursor.execute('''
                    ...
                    VALUES (?, ?, ?, ?, ?, ?, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP)
                ''', (cache_key, ticker.upper(), start_date, end_date, data_type, json.dumps(data)))
                conn.commit()
