...
from duk.config import ConfigurationManager, get_config_manager, get_api_key, validate_required_keys
...
class TestConfigurationManager:
    ...
    def test_load_environment_variables(self):
        ...
        assert self.config_manager.config_data["api_keys"]["fmp_api_key"] == "test_fmp_key"
    ...
    def test_load_environment_variables_missing(self):
        ...
        assert self.config_manager.config_data.get("api_keys", {}).get("fmp_api_key") is None
...
"""
        ...
        with tempfile.NamedTemporaryFile(mode='w', suffix='.toml', delete=False) as f:
            ...
            try:
                ...
                assert config_manager.config_data["api_keys"]["test_key"] == "test_value"
                assert config_manager.config_data["api_keys"]["another_key"] == "another_value"
...
""")
            ...
            with patch.object(config_manager, '_get_config_file_paths', return_value=test_paths):
                with patch.dict(os.environ, {}, clear=True):  # Clear environment vars for this test
            ...
            assert config_manager.config_data["api_keys"]["system_only_key"] == "system_only"
            assert config_manager.config_data["api_keys"]["user_only_key"] == "user_only"
            assert config_manager.config_data["api_keys"]["project_only_key"] == "project_only"
...
""")
                ...
                try:
                    ...
                    with patch.object(config_manager, '_get_config_file_paths', return_value=[Path(f.name)]):
                        config_manager.load_configuration()
