...
class TestFinancialListDownloader:
    ...
    def test_get_index_list_success(self, mock_request):
        ...
        mock_data = [
            {"symbol": "SPX", "name": "S&P 500", "exchange": "INDEX", "currency": "USD"},
            {"symbol": "DJI", "name": "Dow Jones", "exchange": "INDEX", "currency": "USD"},
            {"symbol": "FTSE", "name": "FTSE 100", "exchange": "INDEX", "currency": "GBP"},  # Should be filtered out
        ]
    ...
    def test_get_exchange_list_success(self, mock_request):
        ...
        mock_data = [
            ...
            {"exchangeShortName": "NYSE", "name": "New York Stock Exchange", "countryCode": "US"},
            {"exchangeShortName": "LSE", "name": "London Stock Exchange", "countryCode": "UK"},  # Should be filtered out
        ]
        mock_request.return_value = mock_data
    ...
    def test_get_etf_list_success(self, mock_get_exchanges, mock_request):
        ...
        # Mock ETF data
        mock_data = [
            {"symbol": "SPY", "companyName": "SPDR S&P 500", "exchangeShortName": "NYSE"},
            {"symbol": "QQQ", "companyName": "Invesco QQQ", "exchangeShortName": "NASDAQ"},
            {"symbol": "FOREIGN", "companyName": "Foreign ETF", "exchangeShortName": "LSE"},  # Should be filtered out
        ]
        mock_request.return_value = mock_data
        ...
        mock_request.assert_called_once_with("company-screener", {"country": "US", "isEtf": "true", "isFund": "false"})
...
class TestLSCommand:
    ...
    def test_ls_sp500_without_stock(self):
        ...
        assert result.exit_code == 1
        assert "--sp500 and --nasdaq options can only be used with 'stock'" in result.output
    ...
    def test_ls_stock_sp500(self, mock_get_stocks):
        ...
        mock_data = [
            {"symbol": "AAPL", "companyName": "Apple Inc.", "sector": "Technology", "industry": "Electronics"},
        ]
    ...
    def test_ls_index_json_output(self, mock_get_index):
        ...
        result = self.runner.invoke(main, ["ls", "index", "--format", "json", "--no-cache"])
